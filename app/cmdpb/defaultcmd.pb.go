...
func (c *defaultcmdsrvClient) DefaultCmdDo(ctx context.Context, in *DefaultRequest, opts ...grpc.CallOption) (*DefaultResp, error) {
	out := new(DefaultResp)
	err := c.cc.Invoke(ctx, "/defaultcmdsrv/DefaultCmdDo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Defaultcmdsrv_DefaultCmdDo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/defaultcmdsrv/DefaultCmdDo",
	}
...
func init() { proto.RegisterFile("defaultcmd.proto", fileDescriptor_defaultcmd_487cb1d7b788b48b) }

var fileDescriptor_defaultcmd_487cb1d7b788b48b = []byte{
	// 104 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x48, 0x49, 0x4d, 0x4b,
	0x2c, 0xcd, 0x29, 0x49, 0xce, 0x4d, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x97, 0xe2, 0x85, 0x8a,
	0x40, 0xb8, 0x46, 0x0e, 0x5c, 0xbc, 0x08, 0x25, 0xc5, 0x45, 0x65, 0x42, 0xfa, 0x5c, 0x3c, 0x2e,
	0x10, 0x01, 0xe7, 0xdc, 0x14, 0x97, 0x7c, 0x21, 0x7e, 0x3d, 0x28, 0x37, 0x28, 0xb5, 0xb0, 0x34,
	0xb5, 0xb8, 0x44, 0x8a, 0x07, 0x21, 0x50, 0x5c, 0xa0, 0xc4, 0xe0, 0xc4, 0x19, 0xc5, 0xae, 0x67,
	0x9d, 0x9c, 0x9b, 0x52, 0x90, 0x94, 0xc4, 0x06, 0x36, 0xd3, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff,
	0x40, 0xc3, 0x8f, 0xdd, 0x76, 0x00, 0x00, 0x00,
}
