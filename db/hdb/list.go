...
type List interface {
	Add(node *LinkNode)
	Append(node *LinkNode)
	Del(node *LinkNode)
	UpdateValueOrder(v interface{})
	Find(v interface{}) *LinkNode
	...
	GetLastNode() (node *LinkNode, err error)
...
func (l *list) GetLastNode() (node *LinkNode, err error) {
	if l.root == nil {
		return nil, errors.New("list is empty")
	}
...
func (l *list) Append(node *LinkNode) {
	if node == nil {
		return
	}
	if l.root == nil {
...
func (l *list) Insert(node *LinkNode) {
	if node == nil {
		return
	}
	if l.root == nil {
...
func (l *list) Find(v interface{}) *LinkNode {
	if l.root == nil {
		return nil
	}
